...
> 前置：[M9](m9-workflow-runtime-minimal-loop.md)（实现已交付；Android 验收缺口已由 `MNT-202609-22` 补齐；阶段 E 的直接前置是阶段 B，
> 阶段 C/D 的策略与轨迹语义是输入）
