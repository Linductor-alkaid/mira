...
当前固定版本为 `v0.5.0`（`2ae4fc8`，`MNT-202609-34` 升级。`MNT-202609-33` 曾升至 `e2dc8ca`
吸收停机/提交交错竞态修复与线程池热路径重建；v0.5.0 为该线的正式发布，并逐一收敛 Mira
向上游登记的 TSAN/稳定性发现 executor#185–#188，`e2dc8ca..v0.5.0` 公开 `include/` 头文件
零改动，facade、serial 与 admission 公开契约未变）。
